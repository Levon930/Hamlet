        ...
        <div className="container">
          <div className="intro-item">
            ...
            <div className="intro-item-title">
              ...
              <img src={satelite} alt='satelite' style={{position:'absolute',right:'-40%',width:'538px',height:'516px'}}/>
              <img src={borderStar} alt='*'  style={{position:'absolute',right:'-40%',width:'538px',top:'5%',height:'516px'}}/>
              <img src={businessItsYou} alt="businessItsYou"  style={{position:'absolute',right:'-5%',width:'304px',top:'0',height:'304px'}} />
            </div>
